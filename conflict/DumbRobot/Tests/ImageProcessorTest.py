...
# Example usage:
images_folder_path = "DumbRobot/Data/Images/"
processor = ImageProcessor(images_folder_path + "Desert.jpeg", 8, 8)
print(processor.pixel_data)  # 2D array of (r, g, b) tuples
print(processor.get_brightness(processor.pixel_data[4][7]))  # 2D array of brightness values